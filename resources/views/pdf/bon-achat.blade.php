...
<head>
    <meta charset="utf-8">
    <title>Bon d'Achat #{{ $bonAchat->n_ba }}</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        ...
        <div>
            ...
            <div class="subtitle">Référence: #{{ $bonAchat->n_ba }}</div>
        </div>
    ...
    <table class="products-table">
        ...
        <tbody>
        @foreach($bonAchat->produits as $product)
            <tr>
                <td>{{ $product->nom_prod }}</td>
                <td>{{ $product->pivot->qte_achat }}</td>
                <td>{{ number_format($product->pivot->prix_achat, 2) }} DA</td>
                <td>{{ number_format($product->pivot->qte_achat * $product->pivot->prix_achat, 2) }} DA</td>
            </tr>
        @endforeach
        </tbody>
    </table>
