...
<template>
    ...
    <AppLayout>
        <div class="container mx-auto p-4 sm:p-6 lg:p-8">
            <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight mb-6">Créer une Catégorie</h1>

            <form @submit.prevent="form.post('/categories')" class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                <div class="mb-5">
                    <label for="nom_categ" class="block text-sm font-medium text-gray-700 mb-2">Nom de la Catégorie:</label>
                    <input
                ...
                <div class="mb-8">
                    <label for="id_parent" class="block text-sm font-medium text-gray-700 mb-2">Catégorie Parente:</label>
                    <select
                    ...
                    >
                        ...
                        <option v-for="parent in parentCategories" :key="parent.id_categ" :value="parent.id_categ">
                            {{ parent.nom_categ }}
                        </option>
                    </select>
